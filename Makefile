...
#    Updated: 2019/06/28 13:23:55 by vkosi            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libft.a

SRCS = ft_itoa.c ft_putnbr.c ft_striter.c ft_strrchr.c ft_memalloc.c \
	   ft_putnbr_fd.c ft_striteri.c ft_strrev.c ft_atoi.c ft_memccpy.c \
	   ft_putstr.c ft_strjoin.c ft_strsplit.c ft_bzero.c ft_memchr.c \
