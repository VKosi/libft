...
#    Updated: 2019/05/25 13:34:56 by vkosi            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME=libft.a

SRC=ft_isprint.c ft_lstdelone.c	ft_putendl_fd.c	ft_strclr.c	ft_strjoin.c ft_strnequ.c ft_toupper.c
		ft_atoi.c ft_isupper.c ft_lstiter.c	ft_putnbr.c	ft_strcmp.c	ft_strlen.c	ft_strnew.c
		ft_atoi_base.c ft_itoa.c ft_lstmap.c ft_putnbr_fd.c ft_strcpy.c ft_strmap.c ft_strrchr.c
		ft_isalnum.c ft_itoa_base.c	ft_lstnew.c	ft_putstr.c	ft_strdup.c	ft_strmapi.c ft_strrev.c
		ft_isalpha.c ft_lstadd.c ft_putchar.c ft_putstr_fd.c ft_strequ.c ft_strncat.c ft_strstr.c
		ft_isascii.c ft_lstaddend.c	ft_putchar_fd.c	ft_strcat.c	ft_striter.c ft_strncmp.c ft_strsub.c
		ft_isdigit.c ft_lstdel.c ft_putendl.c ft_strchr.c ft_striteri.c ft_strncpy.c ft_tolower.c
