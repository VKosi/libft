...
#    Updated: 2019/06/25 16:30:49 by vkosi            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libft.a

SRCS =  ft_atoi.c ft_atoi_base.c ft_bzero.c ft_dup.c ft_strsub.c \
		...
		ft_strnew.c ft_strnstr.c ft_strrchr.c ft_strrev.c ft_tolower.c\
		ft_strstr.c ft_strsplit.c ft_strtrim.c ft_word_count.c ft_toupper.c \
